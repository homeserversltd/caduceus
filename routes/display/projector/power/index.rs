pub const NAMESPACE: &str = "display/projector/power";
...
pub fn register(router: axum::Router) -> axum::Router {
    router
        .route(
            "/api/v1/display/projector/power",
            axum::routing::post(power_http),
        )
        .route("/api/v1/pjlink/power", axum::routing::post(power_http))
}
